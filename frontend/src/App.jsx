      ...
      <div className="border-b border-slate-800 bg-slate-900/80 backdrop-blur">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold">Customer Feedback Intelligence Dashboard</h1>
          </div>
          <div className="flex items-center gap-2">
            {accessToken ? (
              <>
                <Link
                  to="/feedback"
                  className="rounded-lg border border-slate-700 px-4 py-2 text-sm font-semibold hover:border-cyan-500 hover:text-cyan-200 transition-colors"
                >
                  Public Form
                </Link>
                <button
          ...
          <div className="space-y-4">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400">
                Automated analysis using Natural Language Processing for improved insights and
                decision-making
              </p>
            </div>
            ...
            <div className="text-center mt-6">
              ...
              >
                Or submit feedback as a customer →
              </Link>
            </div>
          </div>
        ) : (
